...
function Hero() {
  return (
    <div className="flex gap-8 justify-center items-center min-h-96">
      <div className="relative flex-shrink-0 size-0 sm:size-36 md:size-52 lg:size-64 rounded-full overflow-hidden aspect-square shadow-2xl dark:shadow-slate-800">
        <Image
